 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://wsserver.SOAP.concepts/", wsdlLocation = "http://localhost:1212/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://wsserver.SOAP.concepts/", "HelloService");
    ...
    public wsclient.Hello getHelloPort() {
        return super.getPort(new QName("http://wsserver.SOAP.concepts/", "HelloPort"), wsclient.Hello.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloPort")
    public wsclient.Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsserver.SOAP.concepts/", "HelloPort"), wsclient.Hello.class, features);
    }
